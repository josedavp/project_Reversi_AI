...
def main():
    ...
    background_surface = pygame.image.load('D:/Documentos Master/AA-UTSA\CLASSES/Artificial Intelligence/Reversi/project_Reversi_AI/data/background.jpeg')
    background_surface = pygame.transform.scale(background_surface, (800,800))

    white_piece = pygame.image.load('D:/Documentos Master/AA-UTSA\CLASSES/Artificial Intelligence/Reversi/project_Reversi_AI/data/white_piece.png')
    white_piece = pygame.transform.scale(white_piece, (70,70))
    black_piece = pygame.image.load('D:/Documentos Master/AA-UTSA\CLASSES/Artificial Intelligence/Reversi/project_Reversi_AI/data/black_piece.png')
